...
exports('getIsInServicePolice', function()
    ...
    while true do
        ...
        if Config.EnableESXService then
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' then
                exports['artex-3dtextui']:StartText3d("Service", true, {46}, "Press [~g~E~w~] to toggle service", vector3(440.9599609375, -975.85595703125, 30.68960762023925), 3.0, 1.0, false, false, function(pressedKey)
...
function OpenPoliceActionsMenu()
	local elements = {
		...
		{icon = "fas fa-dropbox", title = TranslateCap('object_spawner'), value = 'object_spawner'},
		{icon = "fas fa-id-badge", title = "Jail option", value = 'jailmenu'}
	}
	...
	ESX.OpenContext("right", elements, function(menu,element)
		...
		if data.current.value == 'citizen_interaction' then
			local elements2 = {
				...
				{icon = "fas fa-id-card", title = TranslateCap('id_card'), value = 'identity_card'},
				{icon = "fas fa-spinner", title = TranslateCap('search'), value = 'search'},
				{icon = "fas fa-unlock", title = TranslateCap('handcuff'), value = 'handcuff'},
				{icon = "fas fa-user-plus", title = TranslateCap('drag'), value = 'drag'},
				{icon = "fas fa-user-times", title = TranslateCap('put_in_vehicle'), value = 'put_in_vehicle'},
				{icon = "fas fa-truck", title = TranslateCap('out_the_vehicle'), value = 'out_the_vehicle'},
				{icon = "fas fa-file-text", title = TranslateCap('fine'), value = 'fine'},
				{icon = "fas fa-usd", title = TranslateCap('unpaid_bills'), value = 'unpaid_bills'}
			}
		...
		elseif data.current.value == "object_spawner" then
			local elements4 = {
				{unselectable = true, icon = "fas fa-dropbox", title = element.title},
				{icon = "fas fa-clone", title = TranslateCap('cone'), model = 'prop_roadcone02a'},
				{icon = "fas fa-clone", title = TranslateCap('barrier'), model = 'prop_barrier_work05'},
				{icon = "fas fa-clone", title = TranslateCap('spikestrips'), model = 'p_ld_stinger_s'},
				{icon = "fas fa-clone", title = TranslateCap('box'), model = 'prop_boxpile_07d'},
				{icon = "fas fa-clone", title = TranslateCap('cash'), model = 'hei_prop_cash_crate_half_full'}
			}
...
function OpenFineMenu(player)
    if Config.EnableFinePresets then
        local elements = {
            {unselectable = true, icon = "fas fa-file-text", title = TranslateCap('fine')},
            {icon = "fas fa-check-square", title = TranslateCap('traffic_offense'), value = 0},
            {icon = "fas fa-check-square", title = TranslateCap('minor_offense'),   value = 1},
            {icon = "fas fa-check-square", title = TranslateCap('average_offense'), value = 2},
            {icon = "fas fa-check-square", title = TranslateCap('major_offense'),   value = 3}
        }
...
function OpenFineCategoryMenu(player, category)
	...
	local elements = {
		{unselectable = true, icon = "fas fa-list", title = TranslateCap('fine')}
	}
...
function OpenUnpaidBillsMenu(player)
	local elements = {
		{unselectable = true, icon = "fas fa-usd", title = TranslateCap('unpaid_bills')}
	}
