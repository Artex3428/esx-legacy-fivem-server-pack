...
Config.oxInvenotry = true -- ox only supported. Don't wory it's just for closing the hud while the inventory is open.
...
-- Config.StartEngine = 'O' -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
Config.ToggleSeatbelt = 'B' -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
Config.StressChance = 0.6 -- Default: 10% -- Percentage Stress Chance When Shooting (0-1)
...
Config.MinimumSpeedUnbuckled = 65 -- Going Over This Speed Will Cause Stress
